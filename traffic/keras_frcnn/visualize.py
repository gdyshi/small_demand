...
def change_cv2_draw(image,strs,local,sizes,colour):
    ...
    font = ImageFont.truetype("SIMYOU.TTF",int(30*sizes), encoding="utf-8")
    ...
    for c, boxes in class_boxes_map.items():
        for box in boxes:
            ...
            cv2.rectangle(img, (text_org[0] - 5, text_org[1] + base_line - 5),
                          ...
                          unique_color, -1)
            img=change_cv2_draw(img,text_label,(text_org[0],text_org[1]-15),0.6,(255, 255, 255))
