...
def generate(img_dir_, label_dir_):
    ...
    if not os.path.exists(label_dir_):
        ...
        exit(0)
    all_label_files = [i for i in os.listdir(label_dir_) if i.endswith('.json')]
    ...
    for label_file_name in all_label_files:
        ...
        with open(label_file, 'r') as f:
            ...
            for shape in shapes:
                ...
                target_file.write('{},{},{},{},{},{}\n'.format(
                    os.path.join(img_dir_, label_file_name.replace('json', 'jpg')),
